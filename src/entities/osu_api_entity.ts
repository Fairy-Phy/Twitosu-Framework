...
class osu_api_entity implements osu_api_interface {
	...
	constructor(osu_status: any) {
		if (osu_status == undefined) osu_status = {};
		...
		else this.pp_country_rank = parseInt(osu_status.pp_country_rank);
	}
}
